...
function EditPost() {
    ...
    const fetchPost = async () => {
        const response = await apiInstance.get(`author/dashboard/post-edit/${userId}/${param.id}/`);
    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            const response = await apiInstance.patch(`author/dashboard/post-edit/${userId}/${param.id}/`, formdata, {
                headers: {
                                    ...
                                    <div className="card mb-3">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea value={post.content} onChange={handleCreatePostChange} name="description" className="form-control" id="" cols="30" rows="10"></textarea>
